...
[JsonSerializable(typeof(Modules.Script.NumberRemoteValue), TypeInfoPropertyName = "Script_NumberRemoteValue")]
[JsonSerializable(typeof(Modules.Script.BooleanRemoteValue), TypeInfoPropertyName = "Script_BooleanRemoteValue")]
[JsonSerializable(typeof(Modules.Script.BigIntRemoteValue), TypeInfoPropertyName = "Script_BigIntRemoteValue")]
[JsonSerializable(typeof(Modules.Script.StringRemoteValue), TypeInfoPropertyName = "Script_StringRemoteValue")]
[JsonSerializable(typeof(Modules.Script.NullRemoteValue), TypeInfoPropertyName = "Script_NullRemoteValue")]
[JsonSerializable(typeof(Modules.Script.UndefinedRemoteValue), TypeInfoPropertyName = "Script_UndefinedRemoteValue")]
[JsonSerializable(typeof(Modules.Script.SymbolRemoteValue), TypeInfoPropertyName = "Script_SymbolRemoteValue")]
[JsonSerializable(typeof(Modules.Script.ArrayRemoteValue), TypeInfoPropertyName = "Script_ArrayRemoteValue")]
[JsonSerializable(typeof(Modules.Script.ObjectRemoteValue), TypeInfoPropertyName = "Script_ObjectRemoteValue")]
[JsonSerializable(typeof(Modules.Script.FunctionRemoteValue), TypeInfoPropertyName = "Script_FunctionRemoteValue")]
[JsonSerializable(typeof(Modules.Script.RegExpRemoteValue), TypeInfoPropertyName = "Script_RegExpRemoteValue")]
...
[JsonSerializable(typeof(Modules.Script.DateRemoteValue), TypeInfoPropertyName = "Script_DateRemoteValue")]
[JsonSerializable(typeof(Modules.Script.MapRemoteValue), TypeInfoPropertyName = "Script_MapRemoteValue")]
[JsonSerializable(typeof(Modules.Script.SetRemoteValue), TypeInfoPropertyName = "Script_SetRemoteValue")]
[JsonSerializable(typeof(Modules.Script.WeakMapRemoteValue), TypeInfoPropertyName = "Script_WeakMapRemoteValue")]
[JsonSerializable(typeof(Modules.Script.WeakSetRemoteValue), TypeInfoPropertyName = "Script_WeakSetRemoteValue")]
[JsonSerializable(typeof(Modules.Script.GeneratorRemoteValue), TypeInfoPropertyName = "Script_GeneratorRemoteValue")]
[JsonSerializable(typeof(Modules.Script.ErrorRemoteValue), TypeInfoPropertyName = "Script_ErrorRemoteValue")]
[JsonSerializable(typeof(Modules.Script.ProxyRemoteValue), TypeInfoPropertyName = "Script_ProxyRemoteValue")]
[JsonSerializable(typeof(Modules.Script.PromiseRemoteValue), TypeInfoPropertyName = "Script_PromiseRemoteValue")]
[JsonSerializable(typeof(Modules.Script.TypedArrayRemoteValue), TypeInfoPropertyName = "Script_TypedArrayRemoteValue")]
[JsonSerializable(typeof(Modules.Script.ArrayBufferRemoteValue), TypeInfoPropertyName = "Script_ArrayBufferRemoteValue")]
[JsonSerializable(typeof(Modules.Script.NodeListRemoteValue), TypeInfoPropertyName = "Script_NodeListRemoteValue")]
[JsonSerializable(typeof(Modules.Script.HtmlCollectionRemoteValue), TypeInfoPropertyName = "Script_HtmlCollectionRemoteValue")]
[JsonSerializable(typeof(Modules.Script.NodeRemoteValue), TypeInfoPropertyName = "Script_NodeRemoteValue")]
[JsonSerializable(typeof(Modules.Script.WindowProxyRemoteValue), TypeInfoPropertyName = "Script_WindowProxyRemoteValue")]
